-- Founder / seller dashboards were treating unpaid checkout drafts
-- (status=placed, payment_status=pending|failed) as real orders.
-- Wishlist does not create orders; abandoned card checkouts do.
-- Operational founder metrics must require payment_status = 'paid'.
