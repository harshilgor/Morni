...
export function ProductCardImage({
  ...
  return <Image src={src} alt={alt} fill sizes={sizes} quality={75} unoptimized={unoptimized} priority={priority} onError={() => setFailedSrc(src)} className="object-cover transition duration-500 group-hover:scale-[1.04]" />;
}
