...
export function PartnerWorkspace() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    const { data: response, error: rpcError } = await createClient().rpc("partner_delivery_workspace_data");
