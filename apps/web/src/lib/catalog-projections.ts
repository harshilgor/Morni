...
export const STORE_BROWSER_PRODUCT_SELECT =
  "id, store_id, category_id, title, description, fabric, price_aed, compare_at_price_aed, image_urls, sizes, stock, is_available, created_at, categories(name, slug)" as const;
